      ...
      <InputGroupAddon align="inline-end">
        {showTrigger && (
          <ComboboxTrigger
            ...
            className="group-has-data-[slot=combobox-clear]/input-group:hidden data-pressed:bg-transparent size-6 rounded-[calc(var(--radius)-3px)] p-0 has-[>svg]:p-0 gap-2 text-sm shadow-none flex items-center"
            disabled={disabled}
          />
        )}
