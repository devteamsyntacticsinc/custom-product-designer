...
export function CalendarRange({ date, onSelect, className }: CalendarRangeProps) {
    return (
        <div className={cn("grid gap-2", className)}>
            <Popover>
                ...
                <PopoverContent className="w-auto p-0 shadow-lg border-none" align="end" sideOffset={8}>
